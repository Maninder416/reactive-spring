...
import io.reactivestax.controller.ProductController;
...
class MongodbCrudTests {
    ...
    public void getProductsTest(){
        ...
        StepVerifier.create(responseBody)
                ...
                .expectNext(new ProductDto("104","tv",3,2000))
                .verifyComplete();
    }
    ...
    public void deleteProductTest(){
        Mono<ProductDto> productDtoMono=Mono.just(new ProductDto("102","mobile",1,10000));
        when(productService.deleteProduct("102")).thenReturn(Mono.empty());
